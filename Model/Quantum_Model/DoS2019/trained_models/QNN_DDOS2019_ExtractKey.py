...
# Step 1: Load the PCAP file with TLS filter
...
# Step 2: Extract flow-level statistics
real_flow_data = []
...
# Step 3: Load preprocessed attack samples
...
# Step 4: Filter only DDoS attack samples
...
# Step 5: Simulate each TLS flow as a DDoS sample
final_rows = []
...
# Step 6: Save the simulated DDoS flows
if final_rows:
    ...
    print("\nNo TLS flows were found in the PCAP using the selected version. Please verify the network capture.")
