        ...
        {data && (
          <>
            ...
            <Typography variant="body2" style={{ marginTop: '1rem' }}>
              The simulated traffic shows {Object.keys(data.protocol_distribution).join(', ')} protocol(s), using ports like {Object.keys(data.destination_port_distribution).join(', ')}.
            </Typography>
          </>
        )}
      </Paper>
